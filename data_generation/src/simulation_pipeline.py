...
from data_generation.src.imaging.generator import create_image_simu
...
def create_displacement_image(
    ...
    """
    u_list, warped_image_path = create_image_simu(gmsh_mesh, physical_length, dirichlet, t_end, num_time_steps, zone_radius, zone_center, traction_zone, youngs_modulus, nu, eta, n, name, x_range, y_range, subparts=subparts, num_points=num_points, noise_amplitude=noise_amplitude, num_fourier_modes=num_fourier_modes, lc=lc, grain=grain, seed=seed)
...
def create_test_images(
    ...
    for i, seed in enumerate(seeds):
        ...
        u_ground_truth, img = create_displacement_image(gmsh_mesh, physical_length, dirichlet, t_end, num_time_steps, zone_radius, zone_center, traction_zone, youngs_modulus, nu, eta, n, name, x_range, y_range, num_points, noise_amplitude, num_fourier_modes, lc, grain, seed, subparts)
        images.append(img)
